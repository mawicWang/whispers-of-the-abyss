import {
  Application
} from "./chunk-2NFP4AY3.js";
import "./chunk-V45QF7RP.js";
import "./chunk-AIOZCAM3.js";
import "./chunk-VUMF4NB6.js";
import {
  require_react
} from "./chunk-6VPNIYGA.js";
import "./chunk-3VP6347N.js";
import {
  Graphics,
  TextStyle
} from "./chunk-YXOWDNXQ.js";
    ...
    module2.exports = function($$$config) {
      ...
      function popHydrationState(fiber) {
        ...
        if (shouldClear && nextHydratableInstance) {
          for (shouldClear = nextHydratableInstance; shouldClear; ) {
            var diffNode = buildHydrationDiffNode(fiber, 0), description2 = describeHydratableInstanceForDevWarnings(shouldClear);
            diffNode.serverTail.push(description2);
            shouldClear = "Suspense" === description2.type ? getNextHydratableInstanceAfterSuspenseInstance(shouldClear) : getNextHydratableSibling(shouldClear);
          }
          throwOnHydrationMismatch(fiber);
        }
      ...
      function commitAttachRef(finishedWork) {
        ...
        if (null !== ref) {
          ...
          switch (finishedWork.tag) {
            ...
            case 27:
            case 5:
              instance = getPublicInstance2(instance);
          }
          if ("function" === typeof ref)
            ...
            for (; null !== nextEffect; ) {
              ...
              switch (firstChild.tag) {
                ...
                case 1:
                  ...
                  break;
                case 3:
                  0 !== (flags & 1024) && supportsMutation && clearContainer2(firstChild.stateNode.containerInfo);
                  break;
                case 5:
                case 26:
                case 27:
      ...
      function commitRootWhenReady(root, finishedWork, recoverableErrors, transitions, didIncludeRenderPhaseUpdate, lanes, spawnedLane, updatedLanes, suspendedRetryLanes, didSkipSuspendedSiblings, suspendedCommitReason, completedRenderStartTime, completedRenderEndTime) {
        ...
        if (subtreeFlags & 8192 || 16785408 === (subtreeFlags & 16785408)) {
          if (startSuspendingCommit2(), accumulateSuspenseyCommitOnFiber(finishedWork), finishedWork = waitForCommitToBeReady2(), null !== finishedWork) {
      ...
      function commitRoot(root, recoverableErrors, transitions, didIncludeRenderPhaseUpdate, spawnedLane, updatedLanes, suspendedRetryLanes, suspendedCommitReason, completedRenderStartTime, completedRenderEndTime) {
        var prevTransition = ReactSharedInternals.T, previousUpdateLanePriority = getCurrentUpdatePriority2();
        try {
          setCurrentUpdatePriority2(2), ReactSharedInternals.T = null, commitRootImpl(
            root,
            recoverableErrors,
            transitions,
            didIncludeRenderPhaseUpdate,
          ...
          ReactSharedInternals.T = prevTransition, setCurrentUpdatePriority2(previousUpdateLanePriority);
        }
      }
      function commitRootImpl(root, recoverableErrors, transitions, didIncludeRenderPhaseUpdate, renderPriorityLevel, spawnedLane, updatedLanes, suspendedRetryLanes) {
        ...
        0 !== (finishedWork.subtreeFlags & 15990) || transitions ? (transitions = ReactSharedInternals.T, ReactSharedInternals.T = null, spawnedLane = getCurrentUpdatePriority2(), setCurrentUpdatePriority2(2), updatedLanes = executionContext, executionContext |= CommitContext, commitBeforeMutationEffects(root, finishedWork), commitMutationEffects(
          root,
          finishedWork,
          didIncludeRenderPhaseUpdate
        ), resetAfterCommit2(root.containerInfo), root.current = finishedWork, null !== injectedProfilingHooks && "function" === typeof injectedProfilingHooks.markLayoutEffectsStarted && injectedProfilingHooks.markLayoutEffectsStarted(
          didIncludeRenderPhaseUpdate
        ), commitLayoutEffects(finishedWork, root, didIncludeRenderPhaseUpdate), null !== injectedProfilingHooks && "function" === typeof injectedProfilingHooks.markLayoutEffectsStopped && injectedProfilingHooks.markLayoutEffectsStopped(), requestPaint(), executionContext = updatedLanes, setCurrentUpdatePriority2(spawnedLane), ReactSharedInternals.T = transitions) : root.current = finishedWork;
      ...
      var current = null, isRendering = false, isArrayImpl = Array.isArray, rendererVersion = $$$config.rendererVersion, rendererPackageName = $$$config.rendererPackageName, extraDevToolsConfig = $$$config.extraDevToolsConfig, getPublicInstance2 = $$$config.getPublicInstance, getRootHostContext2 = $$$config.getRootHostContext, getChildHostContext2 = $$$config.getChildHostContext, prepareForCommit2 = $$$config.prepareForCommit, resetAfterCommit2 = $$$config.resetAfterCommit, createInstance2 = $$$config.createInstance, appendInitialChild = $$$config.appendInitialChild, finalizeInitialChildren2 = $$$config.finalizeInitialChildren, shouldSetTextContent2 = $$$config.shouldSetTextContent, createTextInstance2 = $$$config.createTextInstance, scheduleTimeout = $$$config.scheduleTimeout, cancelTimeout = $$$config.cancelTimeout, noTimeout = $$$config.noTimeout, isPrimaryRenderer = $$$config.isPrimaryRenderer;
      $$$config.warnsIfNotActing;
      var supportsMutation = $$$config.supportsMutation, supportsPersistence = $$$config.supportsPersistence, supportsHydration = $$$config.supportsHydration, getInstanceFromNode2 = $$$config.getInstanceFromNode;
      ...
      exports3.batchedUpdates = function(fn, a2) {
        return fn(a2);
      };
      ...
      exports3.defaultOnCaughtError = function(error, errorInfo) {
      ...
      exports3.defaultOnUncaughtError = function(error, errorInfo) {
        reportGlobalError(error);
      ...
      exports3.discreteUpdates = function(fn, a2, b2, c2, d) {
        var prevTransition = ReactSharedInternals.T, previousPriority = getCurrentUpdatePriority2();
        try {
      ...
      exports3.injectIntoDevTools = function() {
        var internals = {
          ...
          findFiberByHostInstance: getInstanceFromNode2,
...
// node_modules/@pixi/react/lib/components/Application.mjs
...
// node_modules/@pixi/react/lib/helpers/log.mjs
...
// node_modules/@pixi/react/lib/helpers/prepareInstance.mjs
...
// node_modules/@pixi/react/lib/package.json.mjs
var name = "@pixi/react";
...
// node_modules/@pixi/react/lib/helpers/afterActiveInstanceBlur.mjs
function afterActiveInstanceBlur() {
  log("info", "lifecycle::afterActiveInstanceBlur");
}

// node_modules/@pixi/react/lib/helpers/attach.mjs
...
// node_modules/@pixi/react/lib/helpers/appendChild.mjs
...
// node_modules/@pixi/react/lib/helpers/beforeActiveInstanceBlur.mjs
function beforeActiveInstanceBlur() {
  log("info", "lifecycle::beforeActiveInstanceBlur");
}

// node_modules/@pixi/react/lib/helpers/clearContainer.mjs
function clearContainer() {
  log("info", "lifecycle::clearContainer");
  return false;
}

// node_modules/@pixi/react/lib/constants/EventPropNames.mjs
var PixiToReactEventPropNames = Object.freeze({
  onclick: "onClick",
...
var ReactToPixiEventPropNames = Object.freeze({
  onClick: "onclick",
  onGlobalMouseMove: "onglobalmousemove",
  onGlobalPointerMove: "onglobalpointermove",
  onGlobalTouchMove: "onglobaltouchmove",
...
// node_modules/@pixi/react/lib/helpers/compare.mjs
...
// node_modules/@pixi/react/lib/constants/ReactIgnoredProps.mjs
var ReactIgnoredProps = Object.freeze([
  "children",
  "key",
  "ref"
]);

// node_modules/@pixi/react/lib/helpers/gentleClone.mjs
...
// node_modules/@pixi/react/lib/helpers/gentleCloneProps.mjs
...
// node_modules/@pixi/react/lib/helpers/diffProps.mjs
...
// node_modules/@pixi/react/lib/helpers/isDiffSet.mjs
...
// node_modules/@pixi/react/lib/helpers/applyProps.mjs
var DEFAULT2 = "__default";
var DEFAULTS_CONTAINERS = /* @__PURE__ */ new Map();
var PIXI_EVENT_PROP_NAME_ERROR_HAS_BEEN_SHOWN = {};
...
// node_modules/@pixi/react/lib/helpers/prepareUpdate.mjs
...
// node_modules/@pixi/react/lib/helpers/commitUpdate.mjs
...
// node_modules/@pixi/react/lib/constants/PixiReactIgnoredProps.mjs
var PixiReactIgnoredProps = Object.freeze([
  ...Object.keys(PixiToReactEventPropNames),
  "draw"
]);

// node_modules/@pixi/react/lib/helpers/catalogue.mjs
var catalogue = {};

// node_modules/@pixi/react/lib/helpers/convertStringToPascalCase.mjs
...
// node_modules/@pixi/react/lib/helpers/parseComponentType.mjs
...
// node_modules/@pixi/react/lib/helpers/createInstance.mjs
function createInstance(type, props, root) {
  log("info", "lifecycle::createInstance");
  const parsedType = parseComponentType(type);
  const name2 = convertStringToPascalCase(parsedType);
  if (!(name2 in catalogue)) {
    throw new Error(`${name2} is not part of the PIXI namespace! Did you forget to extend?`);
  }
  const PixiComponent = catalogue[name2];
...
// node_modules/@pixi/react/lib/helpers/createReconciler.mjs
var import_react_reconciler = __toESM(require_react_reconciler(), 1);
var createReconciler = import_react_reconciler.default;

// node_modules/@pixi/react/lib/helpers/createTextInstance.mjs
...
// node_modules/@pixi/react/lib/helpers/detachDeletedInstance.mjs
function detachDeletedInstance() {
  log("info", "lifecycle::detachDeletedInstance");
}

// node_modules/@pixi/react/lib/helpers/finalizeInitialChildren.mjs
function finalizeInitialChildren() {
  log("info", "lifecycle::finalizeInitialChildren");
  return false;
}

// node_modules/@pixi/react/lib/constants/NO_CONTEXT.mjs
var NO_CONTEXT = {};

// node_modules/@pixi/react/lib/helpers/getChildHostContext.mjs
function getChildHostContext(childHostContext) {
  log("info", "lifecycle::getChildHostContext");
  return childHostContext ?? NO_CONTEXT;
}

// node_modules/@pixi/react/lib/helpers/getCurrentUpdatePriority.mjs
function getCurrentUpdatePriority() {
  log("info", "lifecycle::getCurrentUpdatePriority");
  return store.currentUpdatePriority;
}

// node_modules/@pixi/react/lib/helpers/getInstanceFromNode.mjs
function getInstanceFromNode() {
  log("info", "lifecycle::getInstanceFromNode");
  return null;
}

// node_modules/@pixi/react/lib/helpers/getInstanceFromScope.mjs
function getInstanceFromScope(_scope) {
  log("info", "lifecycle:getInstanceFromScope");
  throw new Error("Not yet implemented.");
}

// node_modules/@pixi/react/lib/helpers/getPublicInstance.mjs
function getPublicInstance(instance) {
  log("info", "lifecycle::getPublicInstance");
  return instance;
}

// node_modules/@pixi/react/lib/helpers/getRootHostContext.mjs
function getRootHostContext() {
  log("info", "lifecycle::getRootHostContext");
  return NO_CONTEXT;
}

// node_modules/@pixi/react/lib/helpers/hideInstance.mjs
...
// node_modules/@pixi/react/lib/helpers/hideTextInstance.mjs
function hideTextInstance(_textInstance) {
  log("info", "lifecycle::hideTextInstance");
  throw new Error("Text instances are not yet supported. Please use a `<text>` component.");
}

// node_modules/@pixi/react/lib/helpers/detach.mjs
...
// node_modules/@pixi/react/lib/helpers/invariant.mjs
...
// node_modules/@pixi/react/lib/helpers/insertBefore.mjs
...
// node_modules/@pixi/react/lib/helpers/maySuspendCommit.mjs
function maySuspendCommit() {
  log("info", "lifecycle::maySuspendCommit");
  return false;
}

// node_modules/@pixi/react/lib/helpers/preloadInstance.mjs
function preloadInstance() {
  log("info", "lifecycle::preloadInstance");
  return true;
}

// node_modules/@pixi/react/lib/helpers/prepareForCommit.mjs
function prepareForCommit() {
  log("info", "lifecycle::prepareForCommit");
  return null;
}

// node_modules/@pixi/react/lib/helpers/preparePortalMount.mjs
function preparePortalMount() {
  log("info", "lifecycle::preparePortalMount");
}

// node_modules/@pixi/react/lib/helpers/prepareScopeUpdate.mjs
function prepareScopeUpdate() {
  log("info", "lifecycle::prepareScopeUpdate");
}

// node_modules/@pixi/react/lib/helpers/removeChild.mjs
...
// node_modules/@pixi/react/lib/helpers/requestPostPaintCallback.mjs
function requestPostPaintCallback(_callback) {
  log("info", "lifecycle::requestPostPaintCallback");
}

// node_modules/@pixi/react/lib/helpers/resetAfterCommit.mjs
function resetAfterCommit() {
  log("info", "lifecycle::resetAfterCommit");
}

// node_modules/@pixi/react/lib/helpers/resetFormInstance.mjs
function resetFormInstance() {
  log("info", "lifecycle::resetFormInstance");
}

// node_modules/@pixi/react/lib/helpers/resolveEventTimeStamp.mjs
function resolveEventTimeStamp() {
  log("info", "lifecycle::resolveEventTimeStamp");
  return -1.1;
}

// node_modules/@pixi/react/lib/helpers/resolveEventType.mjs
function resolveEventType() {
  log("info", "lifecycle::resolveEventType");
  return null;
}

// node_modules/@pixi/react/lib/helpers/resolveUpdatePriority.mjs
...
function resolveUpdatePriority() {
  ...
  const name2 = globalScope.event?.type;
  switch (name2) {
    case "click":
    case "contextmenu":
    case "dblclick":
    ...
    case "pointerdown":
    case "pointerup":
      return import_constants2.DiscreteEventPriority;
    case "pointermove":
    case "pointerout":
    case "pointerover":
    case "pointerenter":
    case "pointerleave":
    case "wheel":
      return import_constants2.ContinuousEventPriority;
    default:
      return import_constants2.DefaultEventPriority;
  }
}

// node_modules/@pixi/react/lib/helpers/setCurrentUpdatePriority.mjs
function setCurrentUpdatePriority(newPriority) {
  log("info", "lifecycle::setCurrentUpdatePriority");
  store.currentUpdatePriority = newPriority;
}

// node_modules/@pixi/react/lib/helpers/shouldAttemptEagerTransition.mjs
function shouldAttemptEagerTransition() {
  log("info", "lifecycle::shouldAttemptEagerTransition");
  return false;
}

// node_modules/@pixi/react/lib/helpers/shouldSetTextContent.mjs
function shouldSetTextContent() {
  log("info", "lifecycle::shouldSetTextContent");
  return false;
}

// node_modules/@pixi/react/lib/helpers/startSuspendingCommit.mjs
function startSuspendingCommit() {
  log("info", "lifecycle::startSuspendingCommit");
}

// node_modules/@pixi/react/lib/helpers/suspendInstance.mjs
function suspendInstance() {
  log("info", "lifecycle::suspendInstance");
}

// node_modules/@pixi/react/lib/helpers/trackSchedulerEvent.mjs
function trackSchedulerEvent() {
  log("info", "lifecycle::trackSchedulerEvent");
}

// node_modules/@pixi/react/lib/helpers/unhideInstance.mjs
...
// node_modules/@pixi/react/lib/helpers/unhideTextInstance.mjs
function unhideTextInstance(_textInstance) {
  log("info", "lifecycle::unhideTextInstance");
  throw new Error("Text instances are not yet supported. Please use a `<text>` component.");
}

// node_modules/@pixi/react/lib/helpers/waitForCommitToBeReady.mjs
function waitForCommitToBeReady() {
  log("info", "lifecycle::waitForCommitToBeReady");
  return null;
}

// node_modules/@pixi/react/lib/core/reconciler.mjs
...
// node_modules/@pixi/react/lib/core/roots.mjs
...
function createRoot(target, options = {}) {
  ...
  const fiber = root?.fiber ?? reconciler.createContainer(
    ...
    // container
    import_constants3.ConcurrentRoot,
    // tag
    null,
    // hydration callbacks
    false,
  ...
  if (!root) {
    ...
    const render = async (children, applicationOptions) => {
      ...
      reconciler.updateContainer(
        (0, import_jsx_runtime.jsx)(ContextProvider, { value: applicationState, children }),
        fiber,
        null,
        () => void 0
      );
...
// node_modules/@pixi/react/lib/helpers/unmountRoot.mjs
...
// node_modules/@pixi/react/lib/helpers/processUnmountQueue.mjs
...
// node_modules/@pixi/react/lib/helpers/queueForUnmount.mjs
...
// node_modules/@pixi/react/lib/helpers/unqueueForUnmount.mjs
...
// node_modules/@pixi/react/lib/hooks/useIsomorphicLayoutEffect.mjs
var import_react2 = __toESM(require_react(), 1);
var useIsomorphicLayoutEffect = typeof window !== "undefined" && (window.document?.createElement || window.navigator?.product === "ReactNative") ? import_react2.useLayoutEffect : import_react2.useEffect;

// node_modules/@pixi/react/lib/components/Application.mjs
var originalDefaultTextStyle = { ...TextStyle.defaultTextStyle };
var ApplicationImplementation = (0, import_react3.forwardRef)(function Application2(props, forwardedRef) {
  const {
    children,
    className,
    defaultTextStyle,
  ...
  const Bridge = x();
  const applicationRef = (0, import_react3.useRef)(null);
  const canvasRef = (0, import_react3.useRef)(null);
  const extensionsRef = (0, import_react3.useRef)(/* @__PURE__ */ new Set());
  (0, import_react3.useImperativeHandle)(forwardedRef, () => ({
    getApplication() {
  ...
  const updateResizeTo = (0, import_react3.useCallback)(() => {
  ...
  const handleInit = (0, import_react3.useCallback)((application) => {
    processUnmountQueue();
  ...
  useIsomorphicLayoutEffect(() => {
    ...
    if (canvasElement) {
      ...
      root.render((0, import_jsx_runtime2.jsx)(Bridge, { children }), applicationProps);
    }
  }, [
    applicationProps,
    children,
...
var Application3 = (0, import_react3.forwardRef)(function ApplicationWrapper(props, ref) {
  return (0, import_jsx_runtime2.jsx)(m, { children: (0, import_jsx_runtime2.jsx)(
...
// node_modules/@pixi/react/lib/helpers/extend.mjs
function extend(objects) {
  Object.assign(catalogue, objects);
}

// node_modules/@pixi/react/lib/hooks/useApplication.mjs
var import_react4 = __toESM(require_react(), 1);
function useApplication() {
  const appContext = (0, import_react4.useContext)(Context);
  invariant(
...
// node_modules/@pixi/react/lib/hooks/useExtend.mjs
...
// node_modules/@pixi/react/lib/hooks/useTick.mjs
