...
interface WorkerControlProps {
    // Props if needed, currently none as state is internal to this control
}

export const WorkerControl: React.FC<WorkerControlProps> = () => {
    ...
    const characterName = `Farmer${color}`; // Worker maps to Farmer assets
